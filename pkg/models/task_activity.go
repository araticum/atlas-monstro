...
func (ta *TaskActivity) Create(*xorm.Session, web.Auth) error { return fmt.Errorf("task activities are read-only") }
func (ta *TaskActivity) ReadOne(*xorm.Session, web.Auth) error { return fmt.Errorf("task activities are read-only") }
func (ta *TaskActivity) Update(*xorm.Session, web.Auth) error { return fmt.Errorf("task activities are read-only") }
func (ta *TaskActivity) Delete(*xorm.Session, web.Auth) error { return fmt.Errorf("task activities are read-only") }
