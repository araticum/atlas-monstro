				...
				>
					...
					>
						<Attachments
							:ref="
								(e) => {
									setFieldRef('attachments', e);
									attachmentsRef = e as any;
								}
							"
							...
							@taskChanged="
								({ coverImageAttachmentId }) =>
									(task.coverImageAttachmentId = coverImageAttachmentId)
							"
						/>
					</div>
				...
				>
					<template v-if="canWrite">
						...
						>
							{{
								task.isFavorite
									? $t("task.detail.actions.unfavorite")
									: $t("task.detail.actions.favorite")
							}}
						</XButton>
						...
						<XButton
							variant="secondary"
							:icon="task.isTemplate ? 'toggle-on' : 'toggle-off'"
							@click="toggleTemplate"
						>
							{{
								task.isTemplate
									? $t("task.detail.actions.unmarkTemplate")
									: $t("task.detail.actions.markTemplate")
							}}
						</XButton>
						<XButton
							variant="secondary"
